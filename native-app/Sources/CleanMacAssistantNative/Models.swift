...
enum MaintenanceCatalog {
    ...
    static let tasks: [MaintenanceTaskDefinition] = [
        ...
        MaintenanceTaskDefinition(
            ...
            subtitle: "Show bulky and old files inside the app.",
            detail: "Runs a read-only report for large files and older items across Desktop, Documents, and Downloads without opening Terminal.",
        ...
        MaintenanceTaskDefinition(
            ...
            subtitle: "List duplicate candidates inside the app.",
            detail: "Runs a read-only duplicate scan for Desktop, Documents, and Downloads. It lists matches but does not delete them.",
