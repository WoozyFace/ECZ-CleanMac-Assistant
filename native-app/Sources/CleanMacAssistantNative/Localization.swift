...
enum AppTranslations {
    static let dutch: [String: String] = [
        ...
        "Overview and smart scan": "Overzicht en slimme scan",
        "Home": "Home",
        "Start here with a calmer smart scan, quick health context, and the main cleanup lanes for this Mac.": "Begin hier met een rustigere slimme scan, snel gezondheidsinzicht en de belangrijkste opschoonroutes voor deze Mac.",
        ...
        "Storage cleanup": "Opslag opschonen",
        "Disk Cleaner": "Schijfopschoner",
        "Review junk files, caches, browser leftovers, mail downloads, and other storage clutter that quietly piles up.": "Bekijk rommelbestanden, caches, browserresten, Mail-downloads en andere opslagrommel die zich stilletjes opstapelt.",
        ...
        "Privacy and safety": "Privacy en veiligheid",
        "Privacy": "Privacy",
        "Cover malware, browser traces, chat leftovers, login items, and persistence points in one cleaner privacy lane.": "Pak malware, browsersporen, chatresten, login-items en opstartpunten samen aan in een overzichtelijkere privacy-pagina.",
        ...
        "Speed and maintenance": "Snelheid en onderhoud",
        "Handle maintenance routines, refresh caches and core processes, check updates, and keep the Mac feeling responsive.": "Voer onderhoudsroutines uit, ververs caches en kernprocessen, controleer updates en houd de Mac vlot aanvoelend.",
        ...
        "Apps and leftovers": "Apps en restbestanden",
        "Remove apps, review orphaned leftovers, reset broken preferences, and jump straight into update surfaces.": "Verwijder apps, bekijk verweesde restbestanden, herstel kapotte voorkeuren en ga direct naar update-schermen.",
        ...
        "Duplicates and files": "Duplicaten en bestanden",
        "Files": "Bestanden",
        "Review duplicate files, large and older files, installer packages, and the Downloads folder from one place.": "Bekijk dubbele bestanden, grote en oudere bestanden, installerpakketten en de Downloads-map vanuit één plek.",
        ...
        "Map disk usage interactively and audit synced cloud folders so storage-heavy areas are easier to spot before cleanup.": "Breng schijfgebruik interactief in kaart en controleer gesynchroniseerde cloudmappen zodat opslagvreters sneller zichtbaar worden vóór het opschonen.",
        ...
        "Remove an app and clean common leftovers.": "Verwijder een app en ruim veelvoorkomende resten op.",
        "Pick an installed app from the list, then the assistant removes that app bundle and clears common user-library leftovers after confirmation.": "Kies een geïnstalleerde app uit de lijst en daarna verwijdert de assistent die app-bundle en ruimt hij na bevestiging veelvoorkomende resten in uw gebruikersbibliotheek op.",
        "Review Orphaned Files": "Verweesde bestanden bekijken",
        "Find leftover app data that no longer matches an installed app.": "Zoek achtergebleven appgegevens die niet meer bij een geïnstalleerde app horen.",
        "Scans common user Library locations for bundle-ID leftovers whose app is no longer installed, then lets you review and remove only the items you trust.": "Scant veelgebruikte locaties in uw gebruikersbibliotheek op bundle-ID-restbestanden waarvan de app niet meer is geïnstalleerd en laat u daarna alleen verwijderen wat u vertrouwt.",
        ...
        "Choose an installed app and delete its saved defaults when you want to reset broken settings without fully reinstalling it yet.": "Kies een geïnstalleerde app en verwijder de opgeslagen voorkeuren wanneer u kapotte instellingen wilt herstellen zonder de app al volledig opnieuw te installeren.",
        ...
        "Review and remove bulky or stale files inside the app.": "Bekijk en verwijder grote of verouderde bestanden in de app.",
        "Scans Desktop, Documents, and Downloads for large or stale files and lets you choose exactly which ones to remove.": "Scant Bureaublad, Documenten en Downloads op grote of verouderde bestanden en laat u precies kiezen welke u wilt verwijderen.",
        "Scan Duplicate Files": "Dubbele bestanden scannen",
        "Review duplicate copies and keep one original inside the app.": "Bekijk dubbele kopieën en bewaar één origineel in de app.",
        "Scans for duplicate files in Desktop, Documents, and Downloads, keeps one suggested original per group, and lets you remove the extra copies.": "Scant op dubbele bestanden in Bureaublad, Documenten en Downloads, bewaart per groep één voorgesteld origineel en laat u de extra kopieën verwijderen.",
        "Clean Installer Files": "Installerbestanden opschonen",
        "Review and remove old installer packages inside the app.": "Bekijk en verwijder oude installatiepakketten in de app.",
        "Scans Downloads, Desktop, and Homebrew cache locations for older installer packages such as DMG, PKG, and XIP files, then lets you remove only the ones you select.": "Scant Downloads, Bureaublad en Homebrew-cachelocaties op oudere installatiepakketten zoals DMG-, PKG- en XIP-bestanden en laat u daarna alleen verwijderen wat u zelf selecteert.",
        ...
        "Choose the installed app you want to remove.": "Kies de geïnstalleerde app die u wilt verwijderen.",
        "Search installed apps": "Geïnstalleerde apps zoeken",
        "Remove app?": "App verwijderen?",
        "The selected app bundle will be deleted from this Mac.": "De geselecteerde app-bundle wordt van deze Mac verwijderd.",
        "Choose the installed app whose preferences you want to reset.": "Kies de geïnstalleerde app waarvan u de voorkeuren wilt resetten.",
        "Reset preferences?": "Voorkeuren resetten?",
        "The saved defaults for the selected app will be deleted.": "De opgeslagen voorkeuren van de geselecteerde app worden verwijderd.",
        "Continue": "Doorgaan",
